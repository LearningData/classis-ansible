...
$CFG->sitename='Classis for {{ school_name }}';
...
$CFG->shortkeyword='{{ password_short_keyword }}';
 ...
 */
$CFG->eportfolio_dataroot = '{{ eportfolio_directory }}';
/**
